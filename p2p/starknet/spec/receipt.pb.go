...
func (x *ReceiptsResponse) GetBlockNumber() uint64 {
	if x != nil {
...
func (x *ReceiptsResponse) GetBlockHash() *Hash {
	if x != nil {
		return x.BlockHash
	}
	return nil
...
type ReceiptsResponse_Receipts struct {
	Receipts *Receipts `protobuf:"bytes,3,opt,name=receipts,proto3,oneof"`
}
...
var file_p2p_proto_receipt_proto_rawDesc = []byte{
	...
	0x6d, 0x73, 0x22, 0xab, 0x01, 0x0a, 0x10, 0x52, 0x65, 0x63, 0x65, 0x69, 0x70, 0x74, 0x73, 0x52,
	...
	0x12, 0x27, 0x0a, 0x08, 0x72, 0x65, 0x63, 0x65, 0x69, 0x70, 0x74, 0x73, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x09, 0x2e, 0x52, 0x65, 0x63, 0x65, 0x69, 0x70, 0x74, 0x73, 0x48, 0x00, 0x52,
	0x08, 0x72, 0x65, 0x63, 0x65, 0x69, 0x70, 0x74, 0x73, 0x12, 0x18, 0x0a, 0x03, 0x66, 0x69, 0x6e,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x04, 0x2e, 0x46, 0x69, 0x6e, 0x48, 0x00, 0x52, 0x03,
...
var file_p2p_proto_receipt_proto_depIdxs = []int32{
	...
	17, // 15: ReceiptsResponse.block_hash:type_name -> Hash
	...
	17, // 19: Receipt.Common.transaction_hash:type_name -> Hash
	...
	17, // 25: Receipt.L1Handler.msg_hash:type_name -> Hash
