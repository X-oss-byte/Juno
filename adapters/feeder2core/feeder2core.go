...
func AdaptCairo1Class(response *feeder.SierraDefinition, compiledClass *feeder.CompiledClass) (*core.Cairo1Class, error) {
	var err error
...
func AdaptCompiledClass(compiledClass *feeder.CompiledClass) (core.CompiledClass, error) {
